export const moduleName = '@thrustdevs/esm-medical-supply-dispensing-app';
...
export const medicalSupplyOrderConceptClass_UUID = '0dcf23d4-3008-4d8e-b12c-4ec95d1cfd97';
